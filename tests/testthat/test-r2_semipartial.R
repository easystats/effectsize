test_that("r2_semipartial basic", {
  ...
  expect_equal(
    sr2_trms[[2]],
    c(0.0162, 0.0469, 0.0023, 6e-04, 4e-04),
    tolerance = 0.01
  )
  expect_equal(
    sr2_pars[[2]],
    c(0.0091, 0, 0.0469, 0.0023, 6e-04, 4e-04),
    tolerance = 0.01
  )
  ...
  # Alternative -------------------------------------------------------------
  expect_equal(
    r2_semipartial(m, alternative = "greater")[c(4, 5)],
  ...
  expect_equal(
    r2_semipartial(m, alternative = "less")[c(4, 5)],
    data.frame(
      CI_low = rep(0, 5),
      CI_high = c(0.0479, 0.1033, 0.0139, 0.0062, 0.0053)
    ),
    ignore_attr = TRUE,
    tolerance = 0.01
  )
  ...
  expect_equal(
    r2_semipartial(m, alternative = "two.sided")[c(4, 5)],
    data.frame(
      CI_low = rep(0, 5),
      CI_high = c(0.054, 0.1141, 0.0161, 0.0073, 0.0062)
    ),
    ignore_attr = TRUE,
    tolerance = 0.01
  )
