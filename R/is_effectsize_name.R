...
es_info <- data.frame(
  name = c(
    ...
    "Cramers_v", "Cramers_v_adjusted", "phi", "phi_adjusted", "Cohens_g", "Cohens_h",
  ...
  label = c(
    ...
    "Cramer's V", "Cramer's V (adj.)", "Phi", "Phi (adj.)", "Cohen's g", "Cohen's h",
  ...
  direction = c(
    ...
    "onetail", "onetail", "onetail", "onetail", "onetail", "onetail",
