...
#' @param select For a data frame, character vector of column names. If \code{NULL} (the default), all variables will be selected.
#' @param exclude For a data frame, character vector of column names to be excluded from selection.
