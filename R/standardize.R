...
#'   outcome) (Gelman, 2008).
#' @param weights Can be `NULL` (for no weighting), or: - For model: if `TRUE`
#'   (default), a weighted-standardization is carried out. - For `data.frame`s:
#'   a numeric vector of weights, or a character of the name of a column in the
#'   `data.frame` that contains the weights.
