...
We can now ask what is the percent of the total variance in `value` that is associated with `treatment`. We can calculate this as 72.23 / (72.23 + 250.96) = 22%. This measure is called Eta-squared (written as $\eta^2$), and can be accessed via the `eta_squared()` function:
