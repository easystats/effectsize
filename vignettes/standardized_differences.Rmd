...
Instead of the *difference* between means, we can also look at the *ratio* between means. This effect size is onlt applicable to **ratio scale** outcomes (variables with an absolute zero).
