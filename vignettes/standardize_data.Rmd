...
ggplot() + 
  geom_density(aes(Z_VariableWise$Subjective_Valence,
                   color = "Z_VariableWise"), size = 1) + 
  geom_density(aes(Z_ParticipantWise$Subjective_Valence,
                   color = "Z_ParticipantWise"), size = 1) + 
...
r <- cor.test(Z_VariableWise$Subjective_Valence,
