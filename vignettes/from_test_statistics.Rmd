...
Similar to $\eta^2_p$, $r$ is a signal to noise ratio, and is in fact equal to $\sqrt{\eta^2_p}$. It is often used instead of $\eta^2_p$ when discussing the *strength* of association (but I suspect people use it instead of $\eta^2_p$ because it gives a bigger number, which looks better).
